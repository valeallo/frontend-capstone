...
<div className="min-h-screen bg-[#2b2b3f]">
  <div className="sidebar  w-[3.35rem] min-h-screen  overflow-hidden border-r  hover:w-56   bg-[#2b2b3f] hover:shadow-lg">
    <div className="flex h-screen flex-col justify-between pt-2 pb-6">
      <div>
        ...
        <ul className="mt-6 space-y-2 tracking-wide">
          ...
          <li className="min-w-max">
          <Link to='/pai'  className="bg group flex items-center space-x-4 rounded-full px-4 py-3 text-gray-600">
              ...
              <span className="group-hover:text-gray-700">New Pai</span>
            </Link>
          </li>
          <li className="min-w-max">
          <Link to='/staff'  className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <span className="group-hover:text-gray-700">Staff</span>
            </Link>
          </li>
          <li className="min-w-max">
            <Link to='/staff/new' className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
              ...
              <span className="group-hover:text-gray-700">Nuovo</span>
            </Link>
          </li>
